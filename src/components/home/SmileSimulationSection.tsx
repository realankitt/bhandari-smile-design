...
export function SmileSimulationSection() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      window.open(
        `https://wa.me/+919999999999?text=Hi, I'm ${formState.name}. I've submitted a smile simulation request at Bhandari Dental Clinic.`,
        "_blank"
      );
    }, 1500);
  };
  ...
  return (
    <section id="simulation" className="section-padding bg-dental-50">
